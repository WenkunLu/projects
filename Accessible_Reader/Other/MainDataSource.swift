...
//  ReadAnd
//
//  Created by Master Lu on 2022/4/9.
//
...
final class MainDataSource {
    ...
    struct SectionModel {
        ...
        init(cellType: CellType, tagType: TagType) {
